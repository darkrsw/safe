...
/**
 * Class ConstructorType, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Sun Oct 23 13:58:52 CEST 2016
 */
@SuppressWarnings("unused")
public class ConstructorType extends TypeLiteral {
    private final List<TypeParam> _tparams;
    private final List<Param> _params;
    private final Type _typ;

    /**
     * Constructs a ConstructorType.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public ConstructorType(ASTSpanInfo in_info, List<TypeParam> in_tparams, List<Param> in_params, Type in_typ) {
        super(in_info);
        if (in_tparams == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'tparams' to the ConstructorType constructor was null");
        }
        _tparams = in_tparams;
        if (in_params == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'params' to the ConstructorType constructor was null");
        }
        _params = in_params;
        if (in_typ == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'typ' to the ConstructorType constructor was null");
        }
        _typ = in_typ;
    }
    ...
    public <RetType> RetType accept(AbstractNodeVisitor<RetType> visitor) {
        return visitor.forConstructorType(this);
    }
    ...
    public void accept(AbstractNodeVisitor_void visitor) {
        visitor.forConstructorType(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            ConstructorType casted = (ConstructorType) obj;
    ...
    public void walk(TreeWalker w) {
        if (w.visitNode(this, "ConstructorType", 4)) {
            ASTSpanInfo temp_info = getInfo();
            ...
            w.endNode(this, "ConstructorType", 4);
        }
    }
