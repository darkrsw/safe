...
/**
 * Class RegExpDot, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Mon Nov 21 18:10:57 CET 2016
 */
@SuppressWarnings("unused")
public class RegExpDot extends RegExpAtom {

    /**
     * Constructs a RegExpDot.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public RegExpDot(RegExpNodeInfo in_info) {
        super(in_info);
    }


    public <RetType> RetType accept(RegExpAbstractNodeVisitor<RetType> visitor) {
        return visitor.forRegExpDot(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            RegExpDot casted = (RegExpDot) obj;
    ...
    public void walk(TreeWalker w) {
        if (w.visitNode(this, "RegExpDot", 1)) {
            RegExpNodeInfo temp_info = getInfo();
            if (w.visitNodeField("info", temp_info)) {
                temp_info.walk(w);
                w.endNodeField("info", temp_info);
            }
            w.endNode(this, "RegExpDot", 1);
        }
    }
