...
/**
 * Class FunctionType, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Sun Oct 23 18:58:00 CEST 2016
 */
@SuppressWarnings("unused")
public class FunctionType extends TypeLiteral {
     ...
     */
    public FunctionType(ASTSpanInfo in_info, List<TypeParam> in_tparams, List<Param> in_params, Type in_typ) {
        super(in_info);
        if (in_tparams == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'tparams' to the FunctionType constructor was null");
        }
        _tparams = in_tparams;
        if (in_params == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'params' to the FunctionType constructor was null");
        }
        _params = in_params;
        if (in_typ == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'typ' to the FunctionType constructor was null");
        }
        _typ = in_typ;
    }
    ...
    public <RetType> RetType accept(AbstractNodeVisitor<RetType> visitor) {
        return visitor.forFunctionType(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            FunctionType casted = (FunctionType) obj;
    ...
    public void walk(TreeWalker w) {
        if (w.visitNode(this, "FunctionType", 4)) {
            ASTSpanInfo temp_info = getInfo();
