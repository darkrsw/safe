...
/**
 * Class WSequenceType, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Mon Oct 24 17:42:25 CEST 2016
 */
@SuppressWarnings("unused")
public class WSequenceType extends WType {
    private final WType _typ;

    /**
     * Constructs a WSequenceType.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public WSequenceType(SpanInfo in_info, List<WTypeSuffix> in_suffix, WType in_typ) {
        super(in_info, in_suffix);
        if (in_typ == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'typ' to the WSequenceType constructor was null");
        }
        _typ = in_typ;
    }
     ...
     */
    public WSequenceType(SpanInfo in_info, WType in_typ) {
    ...
    public <RetType> RetType accept(WIDLVisitor<RetType> visitor) {
        return visitor.forWSequenceType(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            WSequenceType casted = (WSequenceType) obj;
     ...
     */
    protected WSequenceType() {
        _typ = null;
    }

    public void walk(TreeWalker w) {
        if (w.visitNode(this, "WSequenceType", 3)) {
            SpanInfo temp_info = getInfo();
            ...
            w.endNode(this, "WSequenceType", 3);
        }
    }
