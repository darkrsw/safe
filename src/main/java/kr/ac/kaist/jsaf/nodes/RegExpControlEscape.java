...
/**
 * Class RegExpControlEscape, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Sun Oct 23 18:58:01 CEST 2016
 */
@SuppressWarnings("unused")
public class RegExpControlEscape extends RegExpCharacterEscape {
    private final String _str;

    /**
     * Constructs a RegExpControlEscape.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public RegExpControlEscape(RegExpNodeInfo in_info, String in_str) {
        super(in_info);
        if (in_str == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'str' to the RegExpControlEscape constructor was null");
        }
        _str = in_str.intern();
    }
    ...
    public <RetType> RetType accept(RegExpAbstractNodeVisitor<RetType> visitor) {
        return visitor.forRegExpControlEscape(this);
    }
    ...
    public void accept(RegExpAbstractNodeVisitor_void visitor) {
        visitor.forRegExpControlEscape(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            RegExpControlEscape casted = (RegExpControlEscape) obj;
     ...
     */
    protected RegExpControlEscape() {
        _str = null;
    }

    public void walk(TreeWalker w) {
        if (w.visitNode(this, "RegExpControlEscape", 2)) {
            RegExpNodeInfo temp_info = getInfo();
            ...
            w.endNode(this, "RegExpControlEscape", 2);
        }
    }
