...
public class WEAPartial extends WEAttribute {
    ...
    public <RetType> RetType accept(WNodeVisitor<RetType> visitor) {
        return visitor.forWEAPartial(this);
    }

    public void accept(WNodeVisitor_void visitor) {
        visitor.forWEAPartial(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            WEAPartial casted = (WEAPartial) obj;
            return true;
        }
    }
    ...
    public void walk(TreeWalker w) {
        if (w.visitNode(this, "WEAPartial", 0)) {
            w.endNode(this, "WEAPartial", 0);
        }
    }
