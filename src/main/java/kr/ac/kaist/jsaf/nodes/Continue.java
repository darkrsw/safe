...
/**
 * Class Continue, a component of the ASTGen-generated composite hierarchy.
...
public class Continue extends Stmt {
    ...
    /**
     * Constructs a Continue.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public Continue(ASTSpanInfo in_info, Option<Label> in_target) {
        super(in_info);
        if (in_target == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'target' to the Continue constructor was null");
        }
        _target = in_target;
    }
    ...
    public <RetType> RetType accept(AbstractNodeVisitor<RetType> visitor) {
        return visitor.forContinue(this);
    }
    ...
    public void walk(TreeWalker w) {
        if (w.visitNode(this, "Continue", 2)) {
            ASTSpanInfo temp_info = getInfo();
