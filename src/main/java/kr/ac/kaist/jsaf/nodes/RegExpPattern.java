...
/**
 * Class RegExpPattern, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Mon Nov 21 18:10:57 CET 2016
 */
@SuppressWarnings("unused")
public class RegExpPattern extends RegExpAbstractNode {
    private final RegExpDisjunction _disjunction;

    /**
     * Constructs a RegExpPattern.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public RegExpPattern(RegExpNodeInfo in_info, RegExpDisjunction in_disjunction) {
        super(in_info);
        if (in_disjunction == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'disjunction' to the RegExpPattern constructor was null");
        }
    ...
    public <RetType> RetType accept(RegExpAbstractNodeVisitor<RetType> visitor) {
        return visitor.forRegExpPattern(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            RegExpPattern casted = (RegExpPattern) obj;
    ...
    public void walk(TreeWalker w) {
        if (w.visitNode(this, "RegExpPattern", 2)) {
            RegExpNodeInfo temp_info = getInfo();
            ...
            w.endNode(this, "RegExpPattern", 2);
        }
    }
