...
/** An abstract visitor over RegExpAbstractNode that provides a lambda value method;
  * all visit methods are left unimplemented. */
@SuppressWarnings("unused")
public abstract class RegExpAbstractNodeVisitorLambda<RetType> implements edu.rice.cs.plt.lambda.Lambda<RegExpAbstractNode, RetType>, RegExpAbstractNodeVisitor<RetType> {

    public RetType value(RegExpAbstractNode that) {
