...
/**
 * Class RegExpIdentityEscape, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Sun Oct 23 13:58:53 CEST 2016
 */
@SuppressWarnings("unused")
public class RegExpIdentityEscape extends RegExpCharacterEscape {
    private final String _str;

    /**
     * Constructs a RegExpIdentityEscape.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public RegExpIdentityEscape(RegExpNodeInfo in_info, String in_str) {
        super(in_info);
        if (in_str == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'str' to the RegExpIdentityEscape constructor was null");
        }
        _str = in_str.intern();
    }
    ...
    public <RetType> RetType accept(RegExpAbstractNodeVisitor<RetType> visitor) {
        return visitor.forRegExpIdentityEscape(this);
    }
    ...
    public void accept(RegExpAbstractNodeVisitor_void visitor) {
        visitor.forRegExpIdentityEscape(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            RegExpIdentityEscape casted = (RegExpIdentityEscape) obj;
     ...
     */
    protected RegExpIdentityEscape() {
        _str = null;
    }

    public void walk(TreeWalker w) {
        if (w.visitNode(this, "RegExpIdentityEscape", 2)) {
            RegExpNodeInfo temp_info = getInfo();
            ...
            w.endNode(this, "RegExpIdentityEscape", 2);
        }
    }
