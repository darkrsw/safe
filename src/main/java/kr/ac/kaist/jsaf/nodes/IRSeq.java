...
/**
 * Class IRSeq, a component of the ASTGen-generated composite hierarchy.
...
public class IRSeq extends IRStmt {
     ...
     */
    public IRSeq(IRSpanInfo in_info, List<IRStmt> in_stmts) {
        super(in_info);
        if (in_stmts == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'stmts' to the IRSeq constructor was null");
        }
        _stmts = in_stmts;
    }
