...
/**
 * Class CallSig, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Wed Nov 09 11:44:31 CET 2016
 */
@SuppressWarnings("unused")
public class CallSig extends TypeMember {
    private final List<TypeParam> _tparams;
    private final List<Param> _params;
    private final Option<Type> _typ;

    /**
     * Constructs a CallSig.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public CallSig(ASTSpanInfo in_info, List<TypeParam> in_tparams, List<Param> in_params, Option<Type> in_typ) {
        super(in_info);
        if (in_tparams == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'tparams' to the CallSig constructor was null");
        }
        _tparams = in_tparams;
        if (in_params == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'params' to the CallSig constructor was null");
        }
        _params = in_params;
        if (in_typ == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'typ' to the CallSig constructor was null");
        }
        _typ = in_typ;
    }
    ...
    public <RetType> RetType accept(AbstractNodeVisitor<RetType> visitor) {
        return visitor.forCallSig(this);
    }
