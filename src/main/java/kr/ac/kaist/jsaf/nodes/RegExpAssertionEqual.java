...
/**
 * Class RegExpAssertionEqual, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Mon Nov 21 18:10:57 CET 2016
 */
@SuppressWarnings("unused")
public class RegExpAssertionEqual extends RegExpAssertion {
    private final RegExpDisjunction _d;

    /**
     * Constructs a RegExpAssertionEqual.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public RegExpAssertionEqual(RegExpNodeInfo in_info, RegExpDisjunction in_d) {
        super(in_info);
        if (in_d == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'd' to the RegExpAssertionEqual constructor was null");
        }
        _d = in_d;
    }
    ...
    public <RetType> RetType accept(RegExpAbstractNodeVisitor<RetType> visitor) {
        return visitor.forRegExpAssertionEqual(this);
    }
    ...
    public void accept(RegExpAbstractNodeVisitor_void visitor) {
        visitor.forRegExpAssertionEqual(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            RegExpAssertionEqual casted = (RegExpAssertionEqual) obj;
     ...
     */
    protected RegExpAssertionEqual() {
        _d = null;
    }

    public void walk(TreeWalker w) {
        if (w.visitNode(this, "RegExpAssertionEqual", 2)) {
            RegExpNodeInfo temp_info = getInfo();
            ...
            w.endNode(this, "RegExpAssertionEqual", 2);
        }
    }
