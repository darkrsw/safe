...
/** An abstract void visitor over IRAbstractNode that provides a Runnable1 run method;
  * all visit methods are left unimplemented. */
@SuppressWarnings("unused")
public abstract class IRAbstractNodeVisitorRunnable1 implements edu.rice.cs.plt.lambda.Runnable1<IRAbstractNode>, IRAbstractNodeVisitor_void {

    public void run(IRAbstractNode that) {
        that.accept(this);
    }
