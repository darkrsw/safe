...
/**
 * Class SetProp, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Mon Nov 21 18:10:55 CET 2016
 */
@SuppressWarnings("unused")
public class SetProp extends Member {
    private final Functional _ftn;

    /**
     * Constructs a SetProp.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public SetProp(ASTSpanInfo in_info, Property in_prop, Functional in_ftn) {
        super(in_info, in_prop);
        if (in_ftn == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'ftn' to the SetProp constructor was null");
        }
        _ftn = in_ftn;
    }
    ...
    public <RetType> RetType accept(AbstractNodeVisitor<RetType> visitor) {
        return visitor.forSetProp(this);
    }
