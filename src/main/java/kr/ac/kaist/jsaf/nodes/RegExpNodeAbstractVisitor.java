...
/** A parametric abstract implementation of a visitor over RegExpNode that return a value.
...
public abstract class RegExpNodeAbstractVisitor<RetType>  extends RegExpNodeVisitorLambda<RetType> {
    /**
    ...
    **/
    public RetType defaultCase(RegExpNode that) {
    ...
    public RetType forRegExpNode(RegExpNode that) {
        return defaultCase(that);
    }

    public RetType forRegExpAbstractNode(RegExpAbstractNode that) {
        return forRegExpNode(that);
    }
    ...
    public RetType forRegExpNodeInfo(RegExpNodeInfo that) {
        return forRegExpNode(that);
    }

    public RetType forRegExpCapturingParensInfo(RegExpCapturingParensInfo that) {
        return forRegExpNodeInfo(that);
    }

    public RetType forRegExpClassRangesInfo(RegExpClassRangesInfo that) {
        return forRegExpNodeInfo(that);
    }
