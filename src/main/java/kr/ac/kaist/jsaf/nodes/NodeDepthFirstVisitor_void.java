...
public class NodeDepthFirstVisitor_void extends NodeVisitorRunnable1 {
    ...
    **/
    ...
    public void forScopeBodyDoFirst(ScopeBody that) {
        forNodeDoFirst(that);
    }

    public void forTopLevelDoFirst(TopLevel that) {
        forScopeBodyDoFirst(that);
    }

    public void forFunctionalDoFirst(Functional that) {
        forScopeBodyDoFirst(that);
    }

    public void forASTSpanInfoDoFirst(ASTSpanInfo that) {
        forNodeDoFirst(that);
    }
    ...
    public void forPublicModDoFirst(PublicMod that) {
        forModifierDoFirst(that);
    }

    public void forPrivateModDoFirst(PrivateMod that) {
        forModifierDoFirst(that);
    }

    public void forStaticModDoFirst(StaticMod that) {
        forModifierDoFirst(that);
    }
    ...
    public void forScopeBodyOnly(ScopeBody that) {
        forNodeOnly(that);
    }

    public void forTopLevelOnly(TopLevel that) {
        forScopeBodyOnly(that);
    }

    public void forFunctionalOnly(Functional that) {
        forScopeBodyOnly(that);
    }

    public void forASTSpanInfoOnly(ASTSpanInfo that) {
        forNodeOnly(that);
    }
    ...
    public void forPublicModOnly(PublicMod that) {
        forModifierOnly(that);
    }

    public void forPrivateModOnly(PrivateMod that) {
        forModifierOnly(that);
    }

    public void forStaticModOnly(StaticMod that) {
        forModifierOnly(that);
    }
    ...
    public void forTopLevel(TopLevel that) {
        forTopLevelDoFirst(that);
        recurOnListOfFunDecl(that.getFds());
        recurOnListOfVarDecl(that.getVds());
        recurOnListOfSourceElements(that.getStmts());
        forTopLevelOnly(that);
    }

    public void forFunctional(Functional that) {
        forFunctionalDoFirst(that);
        recurOnListOfFunDecl(that.getFds());
        recurOnListOfVarDecl(that.getVds());
        recur(that.getStmts());
        recur(that.getName());
        recurOnListOfId(that.getParams());
        forFunctionalOnly(that);
    }

    public void forASTSpanInfo(ASTSpanInfo that) {
        forASTSpanInfoDoFirst(that);
        recurOnOptionOfComment(that.getComment());
        forASTSpanInfoOnly(that);
    }

    public void forPublicMod(PublicMod that) {
        forPublicModDoFirst(that);
        forPublicModOnly(that);
    }

    public void forPrivateMod(PrivateMod that) {
        forPrivateModDoFirst(that);
        forPrivateModOnly(that);
    }

    public void forStaticMod(StaticMod that) {
        forStaticModDoFirst(that);
        forStaticModOnly(that);
    }
    ...
    public void recurOnListOfFunDecl(List<FunDecl> that) {
        for (FunDecl elt : that) {
            recur(elt);
        }
    }

    public void recurOnListOfSourceElements(List<SourceElements> that) {
        for (SourceElements elt : that) {
            recur(elt);
        }
    }

    public void recurOnOptionOfComment(Option<Comment> that) {
        if (!that.isNone()) recur(that.unwrap());
    }
}
