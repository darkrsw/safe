...
public abstract class TreeWalker {
  ...
  public boolean visitNode(Object node, java.lang.String type, int fields) { return true; }
  /** Visit an AST node's field.  Return {@code true} to recur on the field's value. */
  public boolean visitNodeField(java.lang.String name, Object value) { return true; }
  /** Signal the end of recursion on an AST node's field. */
  public void endNodeField(java.lang.String name, Object value) {}
  ...
  public boolean visitIterated(Object iterable) { return true; }
  /** Visit an iterated element.  Return {@code true} to recur on the element value. */
  public boolean visitIteratedElement(int index, Object element) { return true; }
  /** Signal the end of recursion on an iterated element. */
  public void endIteratedElement(int index, Object element) {}
  ...
  public boolean visitNonEmptyOption(Object option) { return true; }
  ...
  public boolean visitTuple(Object tuple, int arity) { return true; }
  /** Visit a tuple element.  Return {@code true} to recur on the element value. */
  public boolean visitTupleElement(int index, Object element) { return true; }
  /** Signal the end of a tuple element. */
  public void endTupleElement(int index, Object element) {}
