...
/** A parametric interface for visitors over RegExpNode that return a value. */
@SuppressWarnings("unused")
public interface RegExpNodeVisitor<RetType> extends RegExpAbstractNodeVisitor<RetType> {
