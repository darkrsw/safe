...
/**
 * Class IRGetProp, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Fri Nov 18 18:56:40 CET 2016
 */
@SuppressWarnings("unused")
public class IRGetProp extends IRMember {
    private final IRFunctional _ftn;

    /**
     * Constructs a IRGetProp.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public IRGetProp(IRSpanInfo in_info, IRFunctional in_ftn) {
        super(in_info);
        if (in_ftn == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'ftn' to the IRGetProp constructor was null");
        }
        _ftn = in_ftn;
    }
    ...
    public <RetType> RetType accept(IRAbstractNodeVisitor<RetType> visitor) {
        return visitor.forIRGetProp(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            IRGetProp casted = (IRGetProp) obj;
    ...
    public void walk(TreeWalker w) {
        if (w.visitNode(this, "IRGetProp", 2)) {
            IRSpanInfo temp_info = getInfo();
