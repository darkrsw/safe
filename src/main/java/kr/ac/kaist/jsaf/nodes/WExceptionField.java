...
public class WExceptionField extends WMember implements WExceptionMember {
    ...
    /**
     * Constructs a WExceptionField.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public WExceptionField(SpanInfo in_info, List<WEAttribute> in_attrs, WType in_typ, String in_name) {
        super(in_info, in_attrs);
        if (in_typ == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'typ' to the WExceptionField constructor was null");
        }
        _typ = in_typ;
        if (in_name == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'name' to the WExceptionField constructor was null");
        }
     ...
     */
    public WExceptionField(SpanInfo in_info, WType in_typ, String in_name) {
    ...
    public <RetType> RetType accept(WIDLVisitor<RetType> visitor) {
        return visitor.forWExceptionField(this);
    }
    ...
    public void accept(WIDLVisitor_void visitor) {
        visitor.forWExceptionField(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            WExceptionField casted = (WExceptionField) obj;
     ...
     */
    protected WExceptionField() {
        _typ = null;
        _name = null;
    }

    public void walk(TreeWalker w) {
        if (w.visitNode(this, "WExceptionField", 4)) {
            SpanInfo temp_info = getInfo();
            ...
            w.endNode(this, "WExceptionField", 4);
        }
    }
