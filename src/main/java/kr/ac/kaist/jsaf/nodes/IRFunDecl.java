...
/**
 * Class IRFunDecl, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Sun Oct 23 13:58:52 CEST 2016
 */
@SuppressWarnings("unused")
public class IRFunDecl extends IRStmt {
    private final IRFunctional _ftn;

    /**
     * Constructs a IRFunDecl.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public IRFunDecl(IRSpanInfo in_info, IRFunctional in_ftn) {
        super(in_info);
        if (in_ftn == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'ftn' to the IRFunDecl constructor was null");
        }
        _ftn = in_ftn;
    }
    ...
    public <RetType> RetType accept(IRAbstractNodeVisitor<RetType> visitor) {
        return visitor.forIRFunDecl(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            IRFunDecl casted = (IRFunDecl) obj;
    ...
    public void walk(TreeWalker w) {
        if (w.visitNode(this, "IRFunDecl", 2)) {
            IRSpanInfo temp_info = getInfo();
