...
/**
 * Class WException, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Fri Nov 18 18:56:40 CET 2016
 */
@SuppressWarnings("unused")
public class WException extends WDefinition {
    private final String _name;
    private final Option<WId> _parent;
    private final List<WExceptionMember> _members;

    /**
     * Constructs a WException.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public WException(SpanInfo in_info, List<WEAttribute> in_attrs, String in_name, Option<WId> in_parent, List<WExceptionMember> in_members) {
        super(in_info, in_attrs);
        if (in_name == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'name' to the WException constructor was null");
        }
        _name = in_name.intern();
        if (in_parent == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'parent' to the WException constructor was null");
        }
        _parent = in_parent;
        if (in_members == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'members' to the WException constructor was null");
        }
        _members = in_members;
    }
     ...
     */
    public WException(SpanInfo in_info, String in_name, Option<WId> in_parent, List<WExceptionMember> in_members) {
    ...
    final public List<WExceptionMember> getMembers() { return _members; }

    public <RetType> RetType accept(WIDLVisitor<RetType> visitor) {
        return visitor.forWException(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            WException casted = (WException) obj;
            ...
            List<WExceptionMember> temp_members = getMembers();
            List<WExceptionMember> casted_members = casted.getMembers();
    ...
    public void walk(TreeWalker w) {
        if (w.visitNode(this, "WException", 5)) {
            SpanInfo temp_info = getInfo();
            ...
            if (w.visitNodeField("members", temp_members)) {
                if (w.visitIterated(temp_members)) {
                    ...
                    for (WExceptionMember elt_temp_members : temp_members) {
