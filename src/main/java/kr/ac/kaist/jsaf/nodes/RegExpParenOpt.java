...
/**
 * Class RegExpParenOpt, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Wed Nov 09 11:44:32 CET 2016
 */
@SuppressWarnings("unused")
public class RegExpParenOpt extends RegExpAtom {
    private final RegExpDisjunction _disjunction;

    /**
     * Constructs a RegExpParenOpt.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public RegExpParenOpt(RegExpNodeInfo in_info, RegExpDisjunction in_disjunction) {
        super(in_info);
        if (in_disjunction == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'disjunction' to the RegExpParenOpt constructor was null");
        }
    ...
    public <RetType> RetType accept(RegExpAbstractNodeVisitor<RetType> visitor) {
        return visitor.forRegExpParenOpt(this);
    }
    ...
    public void accept(RegExpAbstractNodeVisitor_void visitor) {
        visitor.forRegExpParenOpt(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            RegExpParenOpt casted = (RegExpParenOpt) obj;
     ...
     */
    protected RegExpParenOpt() {
        _disjunction = null;
    }

    public void walk(TreeWalker w) {
        if (w.visitNode(this, "RegExpParenOpt", 2)) {
            RegExpNodeInfo temp_info = getInfo();
            ...
            w.endNode(this, "RegExpParenOpt", 2);
        }
    }
