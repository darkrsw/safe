...
/** An abstract void visitor over RegExpAbstractNode that provides a Runnable1 run method;
  * all visit methods are left unimplemented. */
@SuppressWarnings("unused")
public abstract class RegExpAbstractNodeVisitorRunnable1 implements edu.rice.cs.plt.lambda.Runnable1<RegExpAbstractNode>, RegExpAbstractNodeVisitor_void {

    public void run(RegExpAbstractNode that) {
        that.accept(this);
    }
