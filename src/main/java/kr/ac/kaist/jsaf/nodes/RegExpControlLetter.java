...
/**
 * Class RegExpControlLetter, a component of the ASTGen-generated composite hierarchy.
 * Note: null is not allowed as a value for any field.
 * @version  Generated automatically by ASTGen at Wed Nov 09 11:44:32 CET 2016
 */
@SuppressWarnings("unused")
public class RegExpControlLetter extends RegExpCharacterEscape {
    private final String _str;

    /**
     * Constructs a RegExpControlLetter.
     * @throws java.lang.IllegalArgumentException  If any parameter to the constructor is null.
     */
    public RegExpControlLetter(RegExpNodeInfo in_info, String in_str) {
        super(in_info);
        if (in_str == null) {
            throw new java.lang.IllegalArgumentException("Parameter 'str' to the RegExpControlLetter constructor was null");
        }
        _str = in_str.intern();
    }
    ...
    public <RetType> RetType accept(RegExpAbstractNodeVisitor<RetType> visitor) {
        return visitor.forRegExpControlLetter(this);
    }
    ...
    public void accept(RegExpAbstractNodeVisitor_void visitor) {
        visitor.forRegExpControlLetter(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj.getClass() != this.getClass()) || (obj.hashCode() != this.hashCode())) {
            ...
            RegExpControlLetter casted = (RegExpControlLetter) obj;
     ...
     */
    protected RegExpControlLetter() {
        _str = null;
    }

    public void walk(TreeWalker w) {
        if (w.visitNode(this, "RegExpControlLetter", 2)) {
            RegExpNodeInfo temp_info = getInfo();
            ...
            w.endNode(this, "RegExpControlLetter", 2);
        }
    }
