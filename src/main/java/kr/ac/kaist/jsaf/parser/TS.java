...
// on Wednesday, November 9, 2016 at 11:44:37 AM.
...
/**
 * Packrat parser for grammar <code>kr.ac.kaist.jsaf.parser.TS</code>.
 *
 * <p />This class has been generated by the <i>Rats!</i> parser
 * generator, version 1.14.1, (C) 2004-2008 Robert Grimm.
 */
public final class TS extends ParserBase {
  ...
  static final class Chunk1 {
    Result fDeclarationElement;
    Result fUseStrictDirective;
    Result fSourceElement;
    Result fModuleElement;
    Result fFunctionDeclaration;
    Result fParams;
    Result fParams$$Plus1;
  ...
  static final class TSColumn extends Column {
    Chunk1 chunk1;
    Chunk2 chunk2;
    Chunk3 chunk3;
    Chunk4 chunk4;
   ...
   */
  public TS(final Reader reader, final String file) {
    super(reader, file);
  }
   ...
   */
  public TS(final Reader reader, final String file, final int size) {
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.SourceFile.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  public Result pSourceFile(final int yyStart) throws IOException {
    Result              yyResult;
    int                 yyOption1;
    ...
    yyResult = pTS$initParser(yyStart);
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pDeclarationElements(yyOption1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
        ...
        { // Start scope for a1.
          List<SourceElement> a1 = yyOpValue1;

          yyResult = pTS$closeParser(yyOption1);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.initParser.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTS$initParser(final int yyStart) throws IOException {
    Result     yyResult;
    Void       yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.closeParser.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTS$closeParser(final int yyStart) throws IOException {
    Result     yyResult;
    Void       yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.DeclarationElements.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pDeclarationElements(final int yyStart) throws IOException {
    Result              yyResult;
    int                 yyRepetition1;
    ...
    yyResult = pDeclarationElement(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      ...
      while (true) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyResult = pDeclarationElement(yyResult.index);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.DeclarationElement.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pDeclarationElement(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fDeclarationElement) 
      yyColumn.chunk1.fDeclarationElement = pDeclarationElement$1(yyStart);
    return yyColumn.chunk1.fDeclarationElement;
  }

  /** Actually parse kr.ac.kaist.jsaf.parser.TS.DeclarationElement. */
  private Result pDeclarationElement$1(final int yyStart) throws IOException {
    Result        yyResult;
    int           yyOption1;
    ...
    yyResult = pExportAssignment(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
    ...
    { // Start scope for nested choice.
      ...
      yyResult = pInterfaceDeclaration(yyChoice1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        yyValue = yyResult.semanticValue();
      ...
      yyResult = pTS$ImportDeclaration(yyChoice1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        yyValue = yyResult.semanticValue();
      ...
      yyResult = pExternalImportDeclaration(yyChoice1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        yyValue = yyResult.semanticValue();
      ...
      yyResult = pAmbientDeclaration(yyChoice1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        yyValue = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.ExternalImportDeclaration.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pExternalImportDeclaration(final int yyStart) 
    throws IOException {
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              if (yyResult.hasValue()) {
                ...
                yyResult = pExternalModuleReference(yyResult.index);
                yyError  = yyResult.select(yyError);
                if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.ExternalModuleReference.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pExternalModuleReference(final int yyStart) 
    throws IOException {
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.ExportAssignment.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pExportAssignment(final int yyStart) throws IOException {
    Result           yyResult;
    int              yyOption1;
    ModExpAssignment yyValue;
    ParseError       yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.ImportDeclaration.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTS$ImportDeclaration(final int yyStart) throws IOException {
    Result     yyResult;
    TSImpDecl  yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.$$Shared1.
   * This nonterminal represents the duplicate productions 
   * kr.ac.kaist.jsaf.parser.TS.EntityName, 
   * kr.ac.kaist.jsaf.parser.TS.IdentifierPath, and Type.TypeQueryExpression.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.InterfaceDeclaration.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pInterfaceDeclaration(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyOption1;
    Object     yyOpValue1;
    IntfDecl   yyValue;
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyResult = pTypeParams(yyResult.index);
            yyError  = yyResult.select(yyError);
            if (yyResult.hasValue()) {
              List<TypeParam> v$el$1 = yyResult.semanticValue();
          ...
          { // Start scope for a2.
            List<TypeParam> a2 = cast(yyOpValue1);
            ...
            if (yyResult.hasValue()) {
              ...
              yyResult = pInterfaceExtends(yyResult.index);
              yyError  = yyResult.select(yyError);
              if (yyResult.hasValue()) {
                List<TypeRef> v$el$2 = yyResult.semanticValue();
            ...
            { // Start scope for a3.
              List<TypeRef> a3 = cast(yyOpValue1);

              yyResult = pw(yyOption1);
              yyError  = yyResult.select(yyError);
              if (yyResult.hasValue()) {

                yyResult = pObjectType(yyResult.index);
                yyError  = yyResult.select(yyError);
                if (yyResult.hasValue()) {
                  ObjectType a4 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.InterfaceExtends.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pInterfaceExtends(final int yyStart) throws IOException {
    Result        yyResult;
    List<TypeRef> yyValue;
    ParseError    yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pClassOrInterfaceTypeList(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          yyValue = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.ClassOrInterfaceTypeList.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pClassOrInterfaceTypeList(final int yyStart) 
    throws IOException {

    Result        yyResult;
    int           yyRepetition1;
    Pair<TypeRef> yyRepValue1;
    List<TypeRef> yyValue;
    ParseError    yyError = ParseError.DUMMY;

    // Alternative 1.

    yyResult = pTypeRef(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      TypeRef a1 = yyResult.semanticValue();
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              yyError  = yyResult.select(yyError);
              if (yyResult.hasValue()) {
                TypeRef v$el$1 = yyResult.semanticValue();

                yyRepetition1 = yyResult.index;
                yyRepValue1   = new Pair<TypeRef>(v$el$1, yyRepValue1);
                continue;
              }
            }
          }
      ...
      { // Start scope for a2s.
        Pair<TypeRef> a2s = yyRepValue1.reverse();
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.AmbientDeclaration.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientDeclaration(final int yyStart) throws IOException {
    Result     yyResult;
    AmbDecl    yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pAmbientVariableDeclaration(yyChoice1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          yyValue = yyResult.semanticValue();
        ...
        yyResult = pAmbientFunctionDeclaration(yyChoice1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          yyValue = yyResult.semanticValue();
        ...
        yyResult = pAmbientClassDeclaration(yyChoice1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          yyValue = yyResult.semanticValue();
        ...
        yyResult = pAmbientEnumDeclaration(yyChoice1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          yyValue = yyResult.semanticValue();
        ...
        yyResult = pAmbientModuleDeclaration(yyChoice1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          yyValue = yyResult.semanticValue();
        ...
        yyResult = pAmbientExternalModuleDeclaration(yyChoice1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          yyValue = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.AmbientVariableDeclaration.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientVariableDeclaration(final int yyStart) 
    throws IOException {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyResult = pTypeAnnot(yyResult.index);
            yyError  = yyResult.select(yyError);
            if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.AmbientFunctionDeclaration.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientFunctionDeclaration(final int yyStart) 
    throws IOException {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyResult = pCallSig(yyResult.index);
            yyError  = yyResult.select(yyError);
            if (yyResult.hasValue()) {
              CallSig a2 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.AmbientClassDeclaration.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientClassDeclaration(final int yyStart) 
    throws IOException {
        ...
        if (yyResult.hasValue()) {
          ...
          { // Start scope for a2.
            ...
            if (yyResult.hasValue()) {
              ...
              yyResult = pClassHeritage(yyResult.index);
              yyError  = yyResult.select(yyError);
              if (yyResult.hasValue()) {
                kr.ac.kaist.jsaf.useful.Pair<Option<TypeRef>,List<TypeRef>> a3 = yyResult.semanticValue();
                ...
                if (yyResult.hasValue()) {
                  ...
                  if (yyResult.hasValue()) {
                    ...
                    if (yyResult.hasValue()) {
                      ...
                      yyResult = pAmbientClassBodyElements(yyResult.index);
                      yyError  = yyResult.select(yyError);
                      if (yyResult.hasValue()) {
                        List<AmbClsElt> v$el$2 = yyResult.semanticValue();
                    ...
                    { // Start scope for a4.
                      List<AmbClsElt> a4 = cast(yyOpValue1);
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.ClassHeritage.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pClassHeritage(final int yyStart) throws IOException {
    Result                                                      yyResult;
    int                                                         yyOption1;
    Object                                                      yyOpValue1;
    kr.ac.kaist.jsaf.useful.Pair<Option<TypeRef>,List<TypeRef>> yyValue;
    ParseError                                                  yyError = ParseError.DUMMY;
    ...
    yyResult = pClassExtendsClause(yyOption1);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      TypeRef v$el$1 = yyResult.semanticValue();
    ...
    { // Start scope for a1.
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pImplementsClause(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          List<TypeRef> v$el$2 = yyResult.semanticValue();
      ...
      { // Start scope for a2.
        List<TypeRef> a2 = cast(yyOpValue1);
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.ClassExtendsClause.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pClassExtendsClause(final int yyStart) throws IOException {
    Result     yyResult;
    TypeRef    yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.ImplementsClause.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pImplementsClause(final int yyStart) throws IOException {
    Result        yyResult;
    List<TypeRef> yyValue;
    ParseError    yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.AmbientClassBodyElements.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientClassBodyElements(final int yyStart) 
    throws IOException {

    Result          yyResult;
    int             yyRepetition1;
    Pair<AmbClsElt> yyRepValue1;
    List<AmbClsElt> yyValue;
    ParseError      yyError = ParseError.DUMMY;

    // Alternative 1.

    yyResult = pAmbientClassBodyElement(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      AmbClsElt a1 = yyResult.semanticValue();
      ...
      while (true) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyResult = pAmbientClassBodyElement(yyResult.index);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            AmbClsElt v$el$1 = yyResult.semanticValue();

            yyRepetition1 = yyResult.index;
            yyRepValue1   = new Pair<AmbClsElt>(v$el$1, yyRepValue1);
            continue;
          }
        }
        break;
      ...
      { // Start scope for a2s.
        Pair<AmbClsElt> a2s = yyRepValue1.reverse();
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.AmbientClassBodyElement.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientClassBodyElement(final int yyStart) 
    throws IOException {
    ...
    yyResult = pAmbientConstructorDeclaration(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
    ...
    yyResult = pAmbientPropertyMemberDeclaration(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
    ...
    yyResult = pIndexSig(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      IndexSig a1 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.AmbientConstructorDeclaration.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientConstructorDeclaration(final int yyStart) 
    throws IOException {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyResult = pParamList(yyResult.index);
            yyError  = yyResult.select(yyError);
            if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.AmbientPropertyMemberDeclaration.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientPropertyMemberDeclaration(final int yyStart) 
    throws IOException {
    ...
    yyResult = pPublicOrPrivate(yyOption1);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
    ...
    { // Start scope for a1.
      Modifier a1 = cast(yyOpValue1);

      final int yyChoice1 = yyOption1;

      // Nested alternative 1.

      yyResult = pstatic(yyChoice1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
      ...
      { // Start scope for a2.
        ...
        yyResult = pPropName(yyOption1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Property a3 = yyResult.semanticValue();
          ...
          if (yyResult.hasValue()) {
            ...
            yyError  = yyResult.select(yyError);
            if (yyResult.hasValue()) {
              CallSig a4 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.AmbientEnumDeclaration.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientEnumDeclaration(final int yyStart) 
    throws IOException {

    Result           yyResult;
    int              yyOption1;
    List<AmbEnumMem> yyOpValue1;
    AmbEnumDecl      yyValue;
    ParseError       yyError = ParseError.DUMMY;
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              if (yyResult.hasValue()) {
                ...
                yyResult = pAmbientEnumBody(yyResult.index);
                yyError  = yyResult.select(yyError);
                if (yyResult.hasValue()) {
                  List<AmbEnumMem> v$el$1 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.AmbientEnumBody.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientEnumBody(final int yyStart) throws IOException {
    Result           yyResult;
    int              yyRepetition1;
    Pair<AmbEnumMem> yyRepValue1;
    int              yyOption1;
    List<AmbEnumMem> yyValue;
    ParseError       yyError = ParseError.DUMMY;

    // Alternative 1.

    yyResult = pAmbientEnumMember(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      AmbEnumMem a1 = yyResult.semanticValue();
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              yyResult = pAmbientEnumMember(yyResult.index);
              yyError  = yyResult.select(yyError);
              if (yyResult.hasValue()) {
                AmbEnumMem v$el$1 = yyResult.semanticValue();

                yyRepetition1 = yyResult.index;
                yyRepValue1   = new Pair<AmbEnumMem>(v$el$1, yyRepValue1);
                continue;
              }
            }
          }
      ...
      { // Start scope for a2s.
        Pair<AmbEnumMem> a2s = yyRepValue1.reverse();
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.AmbientEnumMember.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientEnumMember(final int yyStart) throws IOException {
    Result        yyResult;
    int           yyOption1;
    NumberLiteral yyOpValue1;
    AmbEnumMem    yyValue;
    ParseError    yyError = ParseError.DUMMY;
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyError  = yyResult.select(yyError);
            if (yyResult.hasValue()) {
              NumberLiteral v$el$1 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.IntegerLiteral.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pIntegerLiteral(final int yyStart) throws IOException {
    ...
    yyResult = pSignedInteger(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.SignedInteger.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pSignedInteger(final int yyStart) throws IOException {
    Result        yyResult;
    int           yyOption1;
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.$$Shared5.
   * This nonterminal represents the duplicate productions 
   * kr.ac.kaist.jsaf.parser.TS.SignedInteger$$Choice1 
   * and kr.ac.kaist.jsaf.parser.TS.ExponentPart$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.AmbientModuleDeclaration.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientModuleDeclaration(final int yyStart) 
    throws IOException {

    Result          yyResult;
    int             yyOption1;
    List<AmbModElt> yyOpValue1;
    AmbModDecl      yyValue;
    ParseError      yyError = ParseError.DUMMY;
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              if (yyResult.hasValue()) {
                ...
                yyResult = pAmbientModuleElements(yyResult.index);
                yyError  = yyResult.select(yyError);
                if (yyResult.hasValue()) {
                  List<AmbModElt> v$el$1 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.AmbientModuleElements.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientModuleElements(final int yyStart) 
    throws IOException {

    Result          yyResult;
    int             yyRepetition1;
    Pair<AmbModElt> yyRepValue1;
    List<AmbModElt> yyValue;
    ParseError      yyError = ParseError.DUMMY;

    // Alternative 1.

    yyResult = pAmbientModuleElement(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      AmbModElt a1 = yyResult.semanticValue();
      ...
      while (true) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyResult = pAmbientModuleElement(yyResult.index);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            AmbModElt v$el$1 = yyResult.semanticValue();

            yyRepetition1 = yyResult.index;
            yyRepValue1   = new Pair<AmbModElt>(v$el$1, yyRepValue1);
            continue;
          }
        }
        break;
      ...
      { // Start scope for a2s.
        Pair<AmbModElt> a2s = yyRepValue1.reverse();
  ...
  /**
   * Parse nonterminal kr.ac.kaist.jsaf.parser.TS.AmbientModuleElement.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientModuleElement(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyOption1;
    AmbModElt  yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    { // Start scope for nested choice.
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        AmbVarDecl a1 = yyResult.semanticValue();
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        AmbFunDecl a1 = yyResult.semanticValue();
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        AmbClsDecl a1 = yyResult.semanticValue();
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        IntfDecl a1 = yyResult.semanticValue();
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        AmbEnumDecl a1 = yyResult.semanticValue();
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        AmbModDecl a1 = yyResult.semanticValue();
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        TSImpDecl a1 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.AmbientExternalModuleDeclaration.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientExternalModuleDeclaration(final int yyStart) 
    throws IOException {

    Result             yyResult;
    int                yyOption1;
    List<AmbExtModElt> yyOpValue1;
    AmbExtModDecl      yyValue;
    ParseError         yyError = ParseError.DUMMY;
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              if (yyResult.hasValue()) {
                ...
                yyResult = pAmbientExternalModuleElements(yyResult.index);
                yyError  = yyResult.select(yyError);
                if (yyResult.hasValue()) {
                  List<AmbExtModElt> v$el$1 = yyResult.semanticValue();
              ...
              { // Start scope for a2.
                List<AmbExtModElt> a2 = yyOpValue1;
  ...
  /**
   * Parse nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.AmbientExternalModuleElements.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientExternalModuleElements(final int yyStart) 
    throws IOException {

    Result             yyResult;
    int                yyRepetition1;
    Pair<AmbExtModElt> yyRepValue1;
    List<AmbExtModElt> yyValue;
    ParseError         yyError = ParseError.DUMMY;

    // Alternative 1.

    yyResult = pAmbientExternalModuleElement(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      AmbExtModElt a1 = yyResult.semanticValue();
      ...
      while (true) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyResult = pAmbientExternalModuleElement(yyResult.index);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            AmbExtModElt v$el$1 = yyResult.semanticValue();

            yyRepetition1 = yyResult.index;
            yyRepValue1   = new Pair<AmbExtModElt>(v$el$1, yyRepValue1);
            continue;
          }
        }
        break;
      ...
      { // Start scope for a2s.
        Pair<AmbExtModElt> a2s = yyRepValue1.reverse();
  ...
  /**
   * Parse nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.AmbientExternalModuleElement.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pAmbientExternalModuleElement(final int yyStart) 
    throws IOException {

    Result       yyResult;
    int          yyOption1;
    AmbExtModElt yyValue;
    ParseError   yyError = ParseError.DUMMY;
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      ModExpAssignment a1 = yyResult.semanticValue();
    ...
    yyResult = pExternalImportDeclaration(yyOption1);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      ExtImpDecl a1 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal Type.TypeParams.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTypeParams(final int yyStart) throws IOException {
    Result          yyResult;
    List<TypeParam> yyValue;
    ParseError      yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pTypeParamList(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          yyValue = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal Type.TypeParamList.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTypeParamList(final int yyStart) throws IOException {
    Result          yyResult;
    int             yyRepetition1;
    Pair<TypeParam> yyRepValue1;
    List<TypeParam> yyValue;
    ParseError      yyError = ParseError.DUMMY;

    // Alternative 1.

    yyResult = pTypeParam(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      TypeParam a1 = yyResult.semanticValue();
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              yyError  = yyResult.select(yyError);
              if (yyResult.hasValue()) {
                TypeParam v$el$1 = yyResult.semanticValue();

                yyRepetition1 = yyResult.index;
                yyRepValue1   = new Pair<TypeParam>(v$el$1, yyRepValue1);
                continue;
              }
            }
          }
      ...
      { // Start scope for a2s.
        Pair<TypeParam> a2s = yyRepValue1.reverse();
  ...
  /**
   * Parse nonterminal Type.TypeParam.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pTypeParam(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pConstraint(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Type v$el$1 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal Type.Constraint.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pConstraint(final int yyStart) throws IOException {
    Result     yyResult;
    Type       yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  private Result pType(final int yyStart) throws IOException {
    ...
    yyResult = pConstructorType(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
    ...
    if (yyResult.hasValue()) {
      ...
      while (true) {
        ...
        yyResult = pArrayType(yyRepetition1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          Action<Type> v$el$4 = yyResult.semanticValue();

          yyRepetition1 = yyResult.index;
          yyRepValue1   = new Pair<Action<Type>>(v$el$4, yyRepValue1);
          continue;
        }
        break;
      }
  ...
  /**
   * Parse nonterminal Type.ArrayType.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal Type.PredefType.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pPredefType(final int yyStart) throws IOException {
    Result     yyResult;
    PredefType yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      yyValue = TSFactory.makeAnyT(createSpan(yyStart,yyCount));
    ...
    if (yyResult.hasValue()) {
      ...
      yyValue = TSFactory.makeNumberT(createSpan(yyStart,yyCount));
    ...
    if (yyResult.hasValue()) {
      ...
      yyValue = TSFactory.makeBoolT(createSpan(yyStart,yyCount));
    ...
    if (yyResult.hasValue()) {
      ...
      yyValue = TSFactory.makeStringT(createSpan(yyStart,yyCount));
    ...
    if (yyResult.hasValue()) {
      ...
      yyValue = TSFactory.makeVoidT(createSpan(yyStart,yyCount));
  ...
  /**
   * Parse nonterminal Type.TypeRef.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pTypeRef(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pTypeArgs(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal Type.TypeName.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal Type.TypeArgs.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pTypeArgs(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pTypeArgList(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          yyValue = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal Type.TypeArgList.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTypeArgList(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyRepetition1;
  ...
  /**
   * Parse nonterminal Type.FunctionType.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pFunctionType(final int yyStart) throws IOException {
    ...
    yyResult = pTypeParams(yyOption1);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      List<TypeParam> v$el$1 = yyResult.semanticValue();
    ...
    { // Start scope for a1.
      List<TypeParam> a1 = cast(yyOpValue1);
  ...
  /**
   * Parse nonterminal Type.TypeQuery.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTypeQuery(final int yyStart) throws IOException {
    Result     yyResult;
    TypeQuery  yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal Type.ConstructorType.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pConstructorType(final int yyStart) throws IOException {
    int             yyC;
    int             yyIndex;
    Result          yyResult;
    int             yyBase;
  ...
  /**
   * Parse nonterminal Type.ObjectType.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pObjectType(final int yyStart) throws IOException {
    Result           yyResult;
    int              yyOption1;
    List<TypeMember> yyOpValue1;
    ObjectType       yyValue;
    ParseError       yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pTypeBody(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          List<TypeMember> v$el$1 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal Type.TypeBody.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTypeBody(final int yyStart) throws IOException {
    Result           yyResult;
    int              yyOption1;
    List<TypeMember> yyValue;
    ParseError       yyError = ParseError.DUMMY;

    // Alternative 1.

    yyResult = pTypeMemberList(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal Type.TypeMemberList.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTypeMemberList(final int yyStart) throws IOException {
    Result           yyResult;
    int              yyRepetition1;
    Pair<TypeMember> yyRepValue1;
    int              yyOption1;
    List<TypeMember> yyValue;
    ParseError       yyError = ParseError.DUMMY;
    ...
    yyResult = pTypeMember(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      TypeMember a1 = yyResult.semanticValue();
      ...
      while (true) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyResult = pTypeMember(yyResult.index);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            TypeMember v$el$1 = yyResult.semanticValue();

            yyRepetition1 = yyResult.index;
            yyRepValue1   = new Pair<TypeMember>(v$el$1, yyRepValue1);
            continue;
          }
        }
        break;
      ...
      { // Start scope for a2s.
        Pair<TypeMember> a2s = yyRepValue1.reverse();
  ...
  /**
   * Parse nonterminal Type.TypeMember.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTypeMember(final int yyStart) throws IOException {
    Result     yyResult;
    TypeMember yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    yyResult = pConstructSig(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal Type.PropertySig.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pPropertySig(final int yyStart) throws IOException {
    Result      yyResult;
    int         yyOption1;
    Object      yyOpValue1;
    PropertySig yyValue;
  ...
  /**
   * Parse nonterminal Type.CallSig.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pCallSig(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyOption1;
    Object     yyOpValue1;
    CallSig    yyValue;
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              if (yyResult.hasValue()) {
                ...
                yyError  = yyResult.select(yyError);
                if (yyResult.hasValue()) {
                  Type v$el$3 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal Type.ParamList.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal Type.ReqParam.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pReqParam(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyOption1;
    Object     yyOpValue1;
    Param      yyValue;
  ...
  /**
   * Parse nonterminal Type.PublicOrPrivate.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pPublicOrPrivate(final int yyStart) throws IOException {
    Result     yyResult;
    Modifier   yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal Type.OptParam.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pOptParam(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyOption1;
    Object     yyOpValue1;
    Param      yyValue;
  ...
  /**
   * Parse nonterminal Type.RestParam.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pRestParam(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyResult;
    int        yyOption1;
    ...
    // Done.
    yyError = yyError.select("rest param expected", yyStart);
    return yyError;
  }
  ...
  /**
   * Parse nonterminal Type.ConstructSig.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pConstructSig(final int yyStart) throws IOException {
    Result       yyResult;
    int          yyOption1;
    Object       yyOpValue1;
    ConstructSig yyValue;
    ParseError   yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal Type.IndexSig.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pIndexSig(final int yyStart) throws IOException {
    Result     yyResult;
    IndexSig   yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal Type.MethodSig.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pMethodSig(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyOption1;
    String     yyOpValue1;
    MethodSig  yyValue;
    ...
    if (yyResult.hasValue()) {
      ...
      { // Start scope for a2.
        ...
        if (yyResult.hasValue()) {
          ...
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            CallSig a3 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal Type.TypeAnnot.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTypeAnnot(final int yyStart) throws IOException {
    Result     yyResult;
    Type       yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal Declaration.UseStrictDirectives.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pUseStrictDirectives(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyRepetition1;
    boolean    yyRepeated1;
    String     yyValue;
    ...
    yyResult = pUseStrictDirective(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
      ...
      while (true) {
        ...
        yyResult = pUseStrictDirective(yyRepetition1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal Declaration.UseStrictDirective.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pUseStrictDirective(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fUseStrictDirective) 
      yyColumn.chunk1.fUseStrictDirective = pUseStrictDirective$1(yyStart);
    return yyColumn.chunk1.fUseStrictDirective;
  }

  /** Actually parse Declaration.UseStrictDirective. */
  private Result pUseStrictDirective$1(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyResult;
    int        yyBase;
    ...
    // Done.
    yyError = yyError.select("use strict directive expected", yyStart);
    return yyError;
  }
   ...
   * @throws IOException Signals an I/O error.
   */
  private Result pSourceElements(final int yyStart) throws IOException {
    Result              yyResult;
    int                 yyRepetition1;
    Pair<SourceElement> yyRepValue1;
    List<SourceElement> yyValue;
    ...
    yyResult = pSourceElement(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      SourceElement a1 = yyResult.semanticValue();
      ...
      while (true) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyResult = pSourceElement(yyResult.index);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            SourceElement v$el$1 = yyResult.semanticValue();
   ...
   * @throws IOException Signals an I/O error.
   */
  private Result pSourceElement(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fSourceElement) 
      yyColumn.chunk1.fSourceElement = pSourceElement$1(yyStart);
    return yyColumn.chunk1.fSourceElement;
  }

  /** Actually parse Declaration.SourceElement. */
  private Result pSourceElement$1(final int yyStart) throws IOException {
    Result        yyResult;
    SourceElement yyValue;
    ParseError    yyError = ParseError.DUMMY;
    ...
    yyResult = pModuleDeclaration(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
    ...
    yyResult = pDeclaration$ImportDeclaration(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              if (yyResult.hasValue()) {
                ...
                yyResult = pModuleElements(yyResult.index);
                yyError  = yyResult.select(yyError);
                if (yyResult.hasValue()) {
                  List<SourceElement> v$el$1 = yyResult.semanticValue();
   ...
   * @throws IOException Signals an I/O error.
   */
  private Result pModuleElements(final int yyStart) throws IOException {
    Result              yyResult;
    int                 yyRepetition1;
    Pair<SourceElement> yyRepValue1;
    List<SourceElement> yyValue;
    ...
    yyResult = pModuleElement(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      SourceElement a1 = yyResult.semanticValue();
      ...
      while (true) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyResult = pModuleElement(yyResult.index);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            SourceElement v$el$1 = yyResult.semanticValue();
  ...
  private Result pModuleElement(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fModuleElement) 
      yyColumn.chunk1.fModuleElement = pModuleElement$1(yyStart);
    return yyColumn.chunk1.fModuleElement;
  }

  /** Actually parse Declaration.ModuleElement. */
  private Result pModuleElement$1(final int yyStart) throws IOException {
    Result        yyResult;
    SourceElement yyValue;
    ParseError    yyError = ParseError.DUMMY;
    ...
    yyResult = pExportDeclaration(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
   ...
   * @throws IOException Signals an I/O error.
   */
  private Result pExportDeclaration(final int yyStart) throws IOException {
    Result     yyResult;
    ModExport  yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pFunctionDeclaration(yyChoice1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
                  ...
                  if (yyResult.hasValue()) {
                    ...
                    if (yyResult.hasValue()) {
                      ...
                      if (yyResult.hasValue()) {
                        ...
                        yyResult = pFunctionBody(yyResult.index);
                        yyError  = yyResult.select(yyError);
                        if (yyResult.hasValue()) {
        ...
        yyResult = pExportSpecifierSetList(yyChoice1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal Declaration.ExportSpecifierSetList.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pExportSpecifierSetList(final int yyStart) 
    throws IOException {
    ...
    yyResult = pExportSpecifierSet(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      List<ModExpSpecifier> a1 = yyResult.semanticValue();
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              yyResult = pExportSpecifierSet(yyResult.index);
              yyError  = yyResult.select(yyError);
              if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal Declaration.ExportSpecifierSet.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pExportSpecifierSet(final int yyStart) throws IOException {
    Result                yyResult;
    int                   yyRepetition1;
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pExportSpecifier(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal Declaration.ExportSpecifier.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pExportSpecifier(final int yyStart) throws IOException {
    Result          yyResult;
  ...
  /**
   * Parse nonterminal Declaration.ImportDeclaration.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pDeclaration$ImportDeclaration(final int yyStart) 
    throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pImportClauseList(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal Declaration.ImportClauseList.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pImportClauseList(final int yyStart) throws IOException {
    Result          yyResult;
    int             yyRepetition1;
    ...
    yyResult = pImportClause(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              yyResult = pImportClause(yyResult.index);
              yyError  = yyResult.select(yyError);
              if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal Declaration.ImportClause.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pImportClause(final int yyStart) throws IOException {
    Result     yyResult;
    ModImport  yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    yyResult = pImportSpecifierSet(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal Declaration.ImportSpecifierSet.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pImportSpecifierSet(final int yyStart) throws IOException {
    Result                yyResult;
    int                   yyRepetition1;
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pImportSpecifier(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal Declaration.ImportSpecifier.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pImportSpecifier(final int yyStart) throws IOException {
    Result          yyResult;
  ...
  private Result pFunctionDeclaration(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fFunctionDeclaration) 
      yyColumn.chunk1.fFunctionDeclaration = pFunctionDeclaration$1(yyStart);
    return yyColumn.chunk1.fFunctionDeclaration;
  }

  /** Actually parse Declaration.FunctionDeclaration. */
  private Result pFunctionDeclaration$1(final int yyStart) 
    throws IOException {
  ...
  private Result pParams(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fParams) 
      yyColumn.chunk1.fParams = pParams$1(yyStart);
    return yyColumn.chunk1.fParams;
  }
  ...
  private Result pParams$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pParams$$Plus1(yyChoice1);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.Params$$Plus1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pParams$$Plus1(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fParams$$Plus1) 
      yyColumn.chunk1.fParams$$Plus1 = pParams$$Plus1$1(yyStart);
    return yyColumn.chunk1.fParams$$Plus1;
  }

  /** Actually parse kr.ac.kaist.jsaf.parser.TS.Params$$Plus1. */
  private Result pParams$$Plus1$1(final int yyStart) throws IOException {
    Result     yyResult;
    Pair<Id>   yyValue;
    ParseError yyError = ParseError.DUMMY;
   ...
   * @throws IOException Signals an I/O error.
   */
  private Result pFunctionBody(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fFunctionBody) 
      yyColumn.chunk1.fFunctionBody = pFunctionBody$1(yyStart);
    return yyColumn.chunk1.fFunctionBody;
  }

  /** Actually parse Declaration.FunctionBody. */
  private Result pFunctionBody$1(final int yyStart) throws IOException {
    Result                                                    yyResult;
    int                                                       yyOption1;
    String                                                    yyOpValue1;
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pUseStrictDirectives(yyOption1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          String v$el$1 = yyResult.semanticValue();
        ...
        { // Start scope for a1.
          ...
          if (yyResult.hasValue()) {
            ...
            yyResult = pSourceElements(yyChoice1);
            yyError  = yyResult.select(yyError);
            if (yyResult.hasValue()) {
   ...
   * @throws IOException Signals an I/O error.
   */
  private Result pFunctionExpr(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyOption1;
    Object     yyOpValue1;
    LHS        yyValue;
   ...
   * kr.ac.kaist.jsaf.parser.TS.Statement$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.Statement$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pStatement$$Star1(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fStatement$$Star1) 
      yyColumn.chunk1.fStatement$$Star1 = pStatement$$Star1$1(yyStart);
    return yyColumn.chunk1.fStatement$$Star1;
  }

  /** Actually parse kr.ac.kaist.jsaf.parser.TS.Statement$$Star1. */
  ...
  private Result pCaseClauses(final int yyStart) throws IOException {
    ...
    if (null == yyColumn.chunk2.fCaseClauses) 
      yyColumn.chunk2.fCaseClauses = pCaseClauses$1(yyStart);
    return yyColumn.chunk2.fCaseClauses;
  }
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.CaseClauses$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pCaseClauses$$Star1(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fCaseClauses$$Star1) 
      yyColumn.chunk2.fCaseClauses$$Star1 = pCaseClauses$$Star1$1(yyStart);
    return yyColumn.chunk2.fCaseClauses$$Star1;
  }

  /** Actually parse kr.ac.kaist.jsaf.parser.TS.CaseClauses$$Star1. */
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.Expression$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse kr.ac.kaist.jsaf.parser.TS.Expression$$Star1. */
  ...
  private Result pAssignment(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fAssignment) 
      yyColumn.chunk2.fAssignment = pAssignment$1(yyStart);
    return yyColumn.chunk2.fAssignment;
  }
  ...
  private Result pLeftHandSide(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fLeftHandSide) 
      yyColumn.chunk2.fLeftHandSide = pLeftHandSide$1(yyStart);
    return yyColumn.chunk2.fLeftHandSide;
  }
  ...
  private Result pMemberExpr(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fMemberExpr) 
      yyColumn.chunk2.fMemberExpr = pMemberExpr$1(yyStart);
    return yyColumn.chunk2.fMemberExpr;
  }
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.MemberExpr$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pMemberExpr$$Star1(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fMemberExpr$$Star1) 
      yyColumn.chunk2.fMemberExpr$$Star1 = pMemberExpr$$Star1$1(yyStart);
    return yyColumn.chunk2.fMemberExpr$$Star1;
  }

  /** Actually parse kr.ac.kaist.jsaf.parser.TS.MemberExpr$$Star1. */
  ...
  private Result pMemberExprFront(final int yyStart) throws IOException {
    ...
    yyResult = pFunctionExpr(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
  ...
  private Result pAssignmentNoIn(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fAssignmentNoIn) 
      yyColumn.chunk2.fAssignmentNoIn = pAssignmentNoIn$1(yyStart);
    return yyColumn.chunk2.fAssignmentNoIn;
  }
  ...
  private Result pLiteral$NumericLiteral(final int yyStart) 
    ...
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fLiteral$NumericLiteral) 
      yyColumn.chunk2.fLiteral$NumericLiteral = pLiteral$NumericLiteral$1(yyStart);
    return yyColumn.chunk2.fLiteral$NumericLiteral;
  }
  ...
  private Result pHexIntegerLiteral(final int yyStart) throws IOException {
    ...
    if (null == yyColumn.chunk3.fHexIntegerLiteral) 
      yyColumn.chunk3.fHexIntegerLiteral = pHexIntegerLiteral$1(yyStart);
    return yyColumn.chunk3.fHexIntegerLiteral;
  }

  /** Actually parse Literal.HexIntegerLiteral. */
  private Result pHexIntegerLiteral$1(final int yyStart) throws IOException {
    int           yyC;
    int           yyIndex;
    Result        yyResult;
    NumberLiteral yyValue;
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.HexIntegerLiteral$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.DoubleStringCharacter$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.EscapeSequence$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.SingleStringCharacter$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.RegularExpressionFirstChar$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.RegularExpressionChar$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.RegularExpressionNonTerminator$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pRegularExpressionNonTerminator$$Choice1(final int yyStart) 
    ...
    yyPredResult = p$$Shared4(yyStart);
    if (yyPredResult.hasValue()) {
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.RegularExpressionClassChar$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.$$Shared6.
   * This nonterminal represents the duplicate productions 
   * kr.ac.kaist.jsaf.parser.TS.id$$Choice1 
   * and kr.ac.kaist.jsaf.parser.TS.idname$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pIdName(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fIdName) 
      yyColumn.chunk3.fIdName = pIdName$1(yyStart);
    return yyColumn.chunk3.fIdName;
  }
  ...
  private Result pPath(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fPath) 
      yyColumn.chunk3.fPath = pPath$1(yyStart);
    return yyColumn.chunk3.fPath;
  }
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.Path$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pPath$$Star1(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fPath$$Star1) 
      yyColumn.chunk3.fPath$$Star1 = pPath$$Star1$1(yyStart);
    return yyColumn.chunk3.fPath$$Star1;
  }

  /** Actually parse kr.ac.kaist.jsaf.parser.TS.Path$$Star1. */
  ...
  private Result pand(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fand) yyColumn.chunk3.fand = pand$1(yyStart);
    return yyColumn.chunk3.fand;
  }
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.and$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pands(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fands) 
      yyColumn.chunk3.fands = pands$1(yyStart);
    return yyColumn.chunk3.fands;
  }
  ...
  private Result pbar(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fbar) yyColumn.chunk3.fbar = pbar$1(yyStart);
    return yyColumn.chunk3.fbar;
  }
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.bar$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pbars(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fbars) 
      yyColumn.chunk3.fbars = pbars$1(yyStart);
    return yyColumn.chunk3.fbars;
  }
  ...
  private Result pcaret(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fcaret) 
      yyColumn.chunk3.fcaret = pcaret$1(yyStart);
    return yyColumn.chunk3.fcaret;
  }
  ...
  private Result pdoubleplus(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fdoubleplus) 
      yyColumn.chunk4.fdoubleplus = pdoubleplus$1(yyStart);
    return yyColumn.chunk4.fdoubleplus;
  }
  ...
  private Result pdoubleminus(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fdoubleminus) 
      yyColumn.chunk4.fdoubleminus = pdoubleminus$1(yyStart);
    return yyColumn.chunk4.fdoubleminus;
  }
  ...
  private Result pplus(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fplus) 
      yyColumn.chunk4.fplus = pplus$1(yyStart);
    return yyColumn.chunk4.fplus;
  }
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.plus$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pminus(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fminus) 
      yyColumn.chunk4.fminus = pminus$1(yyStart);
    return yyColumn.chunk4.fminus;
  }
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.minus$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pAssignmentOp(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fAssignmentOp) 
      yyColumn.chunk4.fAssignmentOp = pAssignmentOp$1(yyStart);
    return yyColumn.chunk4.fAssignmentOp;
  }
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.AssignmentOp$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pEqualityOp(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fEqualityOp) 
      yyColumn.chunk4.fEqualityOp = pEqualityOp$1(yyStart);
    return yyColumn.chunk4.fEqualityOp;
  }
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.EqualityOp$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.RelationalOp$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.RelationalOpNoIn$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.ShiftOp$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.AdditiveOp$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.MultiplicativeOp$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
    ...
    if ('/' == yyC) {
      ...
      if ('*' == yyC) {
        ...
        { // Start scope for a1s.
          ...
          yyResult = p$$Shared4(yyRepetition1);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            String a2 = yyResult.semanticValue();
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.MultiLineCommentCharNoLB$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.SingleLineComment$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.$$Shared4.
   * This nonterminal represents the duplicate productions 
  ...
  private Result p$$Shared4(final int yyStart) throws IOException {
    ...
    yyResult = p$$Shared4$$Choice1(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      Character a1 = yyResult.semanticValue();
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.$$Shared4$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal 
   * kr.ac.kaist.jsaf.parser.TS.LineTerminatorSequence$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse synthetic nonterminal kr.ac.kaist.jsaf.parser.TS.Space$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result ptypeof(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.ftypeof) 
      yyColumn.chunk4.ftypeof = ptypeof$1(yyStart);
    return yyColumn.chunk4.ftypeof;
  }

  /** Actually parse Keyword.typeof. */
  private Result ptypeof$1(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyPredResult;
    boolean    yyPredMatched;
  ...
  private Result pvoid(final int yyStart) throws IOException {
    TSColumn yyColumn = (TSColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fvoid) 
      yyColumn.chunk4.fvoid = pvoid$1(yyStart);
    return yyColumn.chunk4.fvoid;
  }

  /** Actually parse Keyword.void. */
  ...
  /**
   * Parse nonterminal Keyword.class.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal Keyword.declare.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pdeclare(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyPredResult;
    boolean    yyPredMatched;
              ...
              if ('r' == yyC) {
                ...
                if ('e' == yyC) {
                  ...
                  if (! yyPredMatched) {
                    ...
                    yyError = yyError.select("declare expected", yyStart);
                  }
                }
              }
            }
  ...
  /**
   * Parse nonterminal Keyword.implements.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal Keyword.require.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result prequire(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyPredResult;
    boolean    yyPredMatched;
              ...
              if ('r' == yyC) {
                ...
                if ('e' == yyC) {
                  ...
                  if (! yyPredMatched) {
                    ...
                    yyError = yyError.select("require expected", yyStart);
                  }
                }
              }
            }
  ...
  /**
   * Parse nonterminal Keyword.static.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal Keyword.number.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal Keyword.boolean.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal Keyword.string.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
